...
export default function Home() {
  ...
  const suggestExercises = async (calories: number): Promise<string[]> => {
    return calories > 500
      ? ['45 minutes of running', '30 minutes of cycling', '30 minutes of HIIT']
      : ['30 minutes of running', '15 minutes of cycling', '20 minutes of strength training'];
  };

  const suggestFoodDiet = async (calories: number): Promise<string[]> => {
    return calories > 500
      ? ['Quinoa with grilled chicken', 'Vegetable salad with nuts', 'Avocado smoothie']
      : ['Vegetable salad', 'Grilled chicken breast', 'Fruits like apples and bananas'];
  };
