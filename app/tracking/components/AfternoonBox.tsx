...
interface AfternoonBoxProps {
  medications: Medication[];
  setMedications: React.Dispatch<React.SetStateAction<Medication[]>>;
}

const AfternoonBox: React.FC<AfternoonBoxProps> = ({ medications, setMedications }) => {
  ...
  return (
    <div className="p-6 bg-white text-gray-800 border border-gray-200 rounded-lg shadow-lg max-w-md mx-auto">
      <h2 className="text-2xl font-semibold mb-4 border-b border-gray-300 pb-2">Afternoon Medications</h2>
